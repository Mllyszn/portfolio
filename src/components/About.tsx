        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Ik ben een webontwikkelaar gespecialiseerd in front-end en page-design
              <br /> en het maken van aantrekkelijke user-friendly responsieve websites.
              <br />
              daarnaast ben ik een grote voetbal liefhebber en gamer.
            </p>
