        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-2">
              <p className="text-gray-300 text-lg">Hoi, ik ben Melvin Lieuw</p>
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                Ik bouw responsieve en functionele websites.
              </h1>
            </div>
            
            <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
              ik studeer in webontwikkeling. Momenteel zit ik in mijn 2e jaar
              van Webontwikkeling aan het Grafisch Lyceum Utrecht.
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="border border-gray-600 hover:border-gray-400 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200">
                Contact Me
              </button>
            </div>
          </div>
